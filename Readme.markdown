...
buildscript {
  ...
  dependencies {
    classpath "cloud.wondrify:asset-pipeline-gradle:5.0.12"
  }
}
...
dependencies {        
    ...
    runtime 'cloud.wondrify:asset-pipeline-grails:5.0.12'
    
    // Define needed asset-pipeline plugins with the special assets-scope 
    assets 'cloud.wondrify:less-asset-pipeline:5.0.12'
    assets 'cloud.wondrify:sass-asset-pipeline:5.0.12'
}
```
...
dependencies {
  ...
  compile "cloud.wondrify:asset-pipeline-core:5.0.12"
}
```
